...
@EActivity(R.layout.activity_ex22)
public class Ex22Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //carregar URL
        wv2.loadUrl("https://www.youtube.com/watch?v=88nvjXMCD_Y");
        wv2.setWebViewClient(new WebViewClient());
    }
    //proxima tela
    @Click(R.id.btnProx2)
    public void Ex23(){
        Intent itExercicio23 = new Intent(this, Ex23Activity_.class);
        startActivity(itExercicio23);
    }
}
