...
@EActivity(R.layout.activity_ex32)
public class Ex32Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //carregar URL
        wv2.loadUrl("https://www.youtube.com/watch?v=Y2eg6JCGSFU");
        wv2.setWebViewClient(new WebViewClient());
    }
    //proxima tela
    @Click(R.id.btnProx2)
    public void Ex33(){
        Intent itExercicio33 = new Intent(this, Ex33Activity_.class);
        startActivity(itExercicio33);
    }
}
